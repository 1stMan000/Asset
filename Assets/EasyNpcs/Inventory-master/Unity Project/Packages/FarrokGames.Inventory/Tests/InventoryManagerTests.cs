...
namespace FarrokhGames.Inventory
{
    ...
    public class InventoryManagerTests
    {
        ...
        */
        ...
        {
            var inventory = new InventoryManager(new TestProvider(), 8, 4);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(1, 1), Vector2Int.one), Is.True);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(8, 4), Vector2Int.zero), Is.True);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(3, 3), Vector2Int.right), Is.True);
        }
        ...
        {
            var inventory = new InventoryManager(new TestProvider(), 8, 4);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(1, 5), Vector2Int.zero), Is.False);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(9, 1), Vector2Int.one), Is.False);
        }
        ...
        public void CanAddAt_ItemInTheWay_ReturnsFalse()
        {
            ...
            Assert.That(inventory.allItems.Count, Is.EqualTo(1));
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(1, 1), new Vector2Int(1, 0)), Is.False);
        }
        ...
        {
            var inventory = new InventoryManager(new TestProvider(), 8, 4);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(1, 5), new Vector2Int(-1, 1)), Is.False);
            Assert.That(inventory.check_Addable.CanAddAt(CreateFullItem(9, 1), new Vector2Int(1, -1)), Is.False);
        }
        ...
        public void CanAddAt_ItemAlreadyAdded_ReturnsFalse()
        {
            ...
            var item = CreateFullItem(1, 1);
            inventory.TryAdd(item);
            Assert.That(inventory.check_Addable.CanAddAt(item, Vector2Int.zero), Is.False);
        }
